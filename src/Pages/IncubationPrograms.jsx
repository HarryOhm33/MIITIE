...
const IncubationPrograms = () => {
  const programs = [
    ...
    },
    {
      ...
      benefits: ["Funding access", "Office space", "Legal support", "Market connect"]
    },
    {
      ...
      duration: "Custom",
      benefits: ["Industry mentorship", "Pilot opportunities", "Investment readiness"]
    }
  ];
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {programs.map((program, index) => (
            ...
            >
              ...
              <p className="text-sm font-medium text-orange-500 mb-3">Duration: {program.duration}</p>
